# Graph Report - _notes  (2026-04-24)

## Corpus Check
- Corpus is ~48,478 words - fits in a single context window. You may not need a graph.

## Summary
- 1101 nodes · 1139 edges · 83 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 264 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_AI Agent & Harness Architecture|AI Agent & Harness Architecture]]
- [[_COMMUNITY_Salary Negotiation|Salary Negotiation]]
- [[_COMMUNITY_Context Graph & Decision Tracing|Context Graph & Decision Tracing]]
- [[_COMMUNITY_AI Content Creation System|AI Content Creation System]]
- [[_COMMUNITY_Decision Records & Context|Decision Records & Context]]
- [[_COMMUNITY_Agentic Commerce|Agentic Commerce]]
- [[_COMMUNITY_AI Era Solo Company|AI Era Solo Company]]
- [[_COMMUNITY_AI Design Automation|AI Design Automation]]
- [[_COMMUNITY_AI Product Management|AI Product Management]]
- [[_COMMUNITY_Claude Code Architecture|Claude Code Architecture]]
- [[_COMMUNITY_AGI & AI Safety|AGI & AI Safety]]
- [[_COMMUNITY_Claude Browser Agent|Claude Browser Agent]]
- [[_COMMUNITY_LLM Security|LLM Security]]
- [[_COMMUNITY_Personal Development|Personal Development]]
- [[_COMMUNITY_Workplace Politics|Workplace Politics]]
- [[_COMMUNITY_Knowledge Graph & Ontology|Knowledge Graph & Ontology]]
- [[_COMMUNITY_Property & Subscription Economy|Property & Subscription Economy]]
- [[_COMMUNITY_Gemini Voice Agent|Gemini Voice Agent]]
- [[_COMMUNITY_Obsidian Plugins|Obsidian Plugins]]
- [[_COMMUNITY_Career & Workplace Dynamics|Career & Workplace Dynamics]]
...
- [[_COMMUNITY_Economics & Human Behavior|Economics & Human Behavior]]
- [[_COMMUNITY_Amazon Interview & Leadership|Amazon Interview & Leadership]]
- [[_COMMUNITY_Marp AI Presentations|Marp AI Presentations]]
...
- [[_COMMUNITY_Enterprise Context Infrastructure|Enterprise Context Infrastructure]]
- [[_COMMUNITY_Decision Hygiene & Agent Economy|Decision Hygiene & Agent Economy]]
- [[_COMMUNITY_Explanation Artifacts Framework|Explanation Artifacts Framework]]
- [[_COMMUNITY_AI Agent Testing & Red Flags|AI Agent Testing & Red Flags]]
- [[_COMMUNITY_AI Transformation Adoption|AI Transformation Adoption]]
- [[_COMMUNITY_Context Window & Desktop Theory|Context Window & Desktop Theory]]
- [[_COMMUNITY_AI Design Direction|AI Design Direction]]
- [[_COMMUNITY_AI Native Engineering|AI Native Engineering]]
- [[_COMMUNITY_AI Startup Revenue|AI Startup Revenue]]
- [[_COMMUNITY_Lifestyle Medicine & Wellness|Lifestyle Medicine & Wellness]]
- [[_COMMUNITY_Workplace Political Navigation|Workplace Political Navigation]]
- [[_COMMUNITY_LLM Evaluation Systems|LLM Evaluation Systems]]
- [[_COMMUNITY_Handling Political Operators|Handling Political Operators]]
- [[_COMMUNITY_NVIDIA & Physical AI|NVIDIA & Physical AI]]
- [[_COMMUNITY_Finance Risk & Life Philosophy|Finance Risk & Life Philosophy]]
- [[_COMMUNITY_Scrum in AI Agent Era|Scrum in AI Agent Era]]
- [[_COMMUNITY_Metacognition & Thinking Habits|Metacognition & Thinking Habits]]
- [[_COMMUNITY_Claude Memory Patterns|Claude Memory Patterns]]
- [[_COMMUNITY_High Agency Mindset|High Agency Mindset]]
- [[_COMMUNITY_Brain & Self-Identity|Brain & Self-Identity]]
- [[_COMMUNITY_Dog Attachment Psychology|Dog Attachment Psychology]]
- [[_COMMUNITY_AI Agent Economy Trends|AI Agent Economy Trends]]
- [[_COMMUNITY_AI Cloud Employee & MCP|AI Cloud Employee & MCP]]
- [[_COMMUNITY_Prompt Simplification|Prompt Simplification]]
- [[_COMMUNITY_Delivery Time Collapse|Delivery Time Collapse]]
- [[_COMMUNITY_Setup Addiction & Output Focus|Setup Addiction & Output Focus]]
- [[_COMMUNITY_CLI Automation Tools|CLI Automation Tools]]
- [[_COMMUNITY_Cognitive Curiosity & Openness|Cognitive Curiosity & Openness]]
- [[_COMMUNITY_Gemini Live API|Gemini Live API]]
- [[_COMMUNITY_Grey Rock Effect|Grey Rock Effect]]
- [[_COMMUNITY_Marriage & Strong Mindset|Marriage & Strong Mindset]]
- [[_COMMUNITY_Tension Headache Relief|Tension Headache Relief]]
- [[_COMMUNITY_Karpathy Agent Principles|Karpathy Agent Principles]]
- [[_COMMUNITY_Manager Dynamics & Reorgs|Manager Dynamics & Reorgs]]
- [[_COMMUNITY_Anti-Aging Habits|Anti-Aging Habits]]
- [[_COMMUNITY_AI Civilization Externalization|AI Civilization Externalization]]
- [[_COMMUNITY_Defensive Coding & Review|Defensive Coding & Review]]
- [[_COMMUNITY_AI Behavior Prediction Limits|AI Behavior Prediction Limits]]
- [[_COMMUNITY_AI Product Design Process|AI Product Design Process]]
- [[_COMMUNITY_Intent Laundering Security|Intent Laundering Security]]
...
- [[_COMMUNITY_AI Era Human Survival|AI Era Human Survival]]
- [[_COMMUNITY_Distributed Systems Patterns|Distributed Systems Patterns]]
- [[_COMMUNITY_Mitochondria & Longevity|Mitochondria & Longevity]]
- [[_COMMUNITY_Power & Self-Mastery|Power & Self-Mastery]]
- [[_COMMUNITY_Markdown & LLM Input Optimization|Markdown & LLM Input Optimization]]
- [[_COMMUNITY_Workplace Legal Defense|Workplace Legal Defense]]
- [[_COMMUNITY_Microeconomics Principles|Microeconomics Principles]]
- [[_COMMUNITY_Workplace Harassment Defense|Workplace Harassment Defense]]
- [[_COMMUNITY_Claude Social Media Automation|Claude Social Media Automation]]
- [[_COMMUNITY_Hip Recovery Exercises|Hip Recovery Exercises]]
- [[_COMMUNITY_iPhone Files App Features|iPhone Files App Features]]
- [[_COMMUNITY_Strategic Disappearance|Strategic Disappearance]]
- [[_COMMUNITY_AI Productivity Paradox|AI Productivity Paradox]]
- [[_COMMUNITY_Incentive & Scarcity Alignment|Incentive & Scarcity Alignment]]

## God Nodes (most connected - your core abstractions)
1. `Obsidian 必裝插件：新手打造第二大腦的 8 款神器` - 13 edges
2. `情境基礎設施 (Context Infrastructure)` - 11 edges
3. `1-3-3 安裝法則` - 8 edges
...
### Community 0 - "AI Agent & Harness Architecture"
Cohesion: 0.04
...
### Community 16 - "Property & Subscription Economy"
Cohesion: 0.1
Nodes (21): 黑暗模式, 所有權, 訂閱制陷阱, 房產贈與稅務陷阱, 資產傳承策略, 公告現值, 產業聚落效應, 矽盾 (+13 more)

### Community 17 - "Gemini Voice Agent"
Cohesion: 0.11
...
- **Should `AI Agent & Harness Architecture` be split into smaller, more focused modules?**
  _Cohesion score 0.04 - nodes in this community are weakly interconnected._
- **Should `Salary Negotiation` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._
- **Should `Context Graph & Decision Tracing` be split into smaller, more focused modules?**
