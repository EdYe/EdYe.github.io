# Graph Report - ./_notes  (2026-04-20)

## Corpus Check
- 249 files · ~43,583 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 908 nodes · 924 edges · 69 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 213 edges (avg confidence: 0.79)
...
- [[_COMMUNITY_AI-Era Productivity|AI-Era Productivity]]
- [[_COMMUNITY_AI Design & Web Automation|AI Design & Web Automation]]
- [[_COMMUNITY_AI Product Management|AI Product Management]]
- [[_COMMUNITY_Claude Code Architecture|Claude Code Architecture]]
- [[_COMMUNITY_AI Content Creation|AI Content Creation]]
- [[_COMMUNITY_AGI & AI Safety|AGI & AI Safety]]
- [[_COMMUNITY_Claude Tools & Browser Agents|Claude Tools & Browser Agents]]
- [[_COMMUNITY_LLM Security Vulnerabilities|LLM Security Vulnerabilities]]
- [[_COMMUNITY_Personal Development & Mindset|Personal Development & Mindset]]
- [[_COMMUNITY_Workplace Politics & Power|Workplace Politics & Power]]
...
- [[_COMMUNITY_Career Agency & Managers|Career Agency & Managers]]
...
- [[_COMMUNITY_Leadership & Interviews|Leadership & Interviews]]
- [[_COMMUNITY_AI Presentation Automation|AI Presentation Automation]]
- [[_COMMUNITY_Wealth & Leverage Finance|Wealth & Leverage Finance]]
- [[_COMMUNITY_Influence Without Authority|Influence Without Authority]]
- [[_COMMUNITY_Enterprise Context Graph|Enterprise Context Graph]]
- [[_COMMUNITY_Decision Hygiene & Meetings|Decision Hygiene & Meetings]]
- [[_COMMUNITY_AI Agent Development Practices|AI Agent Development Practices]]
- [[_COMMUNITY_AI Boss Mindset|AI Boss Mindset]]
- [[_COMMUNITY_Context Window Strategies|Context Window Strategies]]
- [[_COMMUNITY_AI Design Systems|AI Design Systems]]
- [[_COMMUNITY_AI-Native Engineering|AI-Native Engineering]]
- [[_COMMUNITY_AI Startup Revenue|AI Startup Revenue]]
- [[_COMMUNITY_Anti-Cancer Wellness|Anti-Cancer Wellness]]
- [[_COMMUNITY_Workplace Political Navigation|Workplace Political Navigation]]
- [[_COMMUNITY_AI Evaluation & LLM Judges|AI Evaluation & LLM Judges]]
- [[_COMMUNITY_Handling Political Operators|Handling Political Operators]]
- [[_COMMUNITY_NVIDIA & Physical AI|NVIDIA & Physical AI]]
- [[_COMMUNITY_Financial Risk Philosophy|Financial Risk Philosophy]]
- [[_COMMUNITY_AI-Era Scrum & SDLC|AI-Era Scrum & SDLC]]
- [[_COMMUNITY_Metacognition & Thinking|Metacognition & Thinking]]
- [[_COMMUNITY_AI-Era Curiosity & Agency|AI-Era Curiosity & Agency]]
...
- [[_COMMUNITY_Prompt Simplification Philosophy|Prompt Simplification Philosophy]]
- [[_COMMUNITY_Delivery Time & Estimation|Delivery Time & Estimation]]
- [[_COMMUNITY_Output Over Setup Mindset|Output Over Setup Mindset]]
- [[_COMMUNITY_CLI & Terminal Productivity|CLI & Terminal Productivity]]
- [[_COMMUNITY_Cognitive Curiosity & Overload|Cognitive Curiosity & Overload]]
- [[_COMMUNITY_Gemini Voice & Multimodal|Gemini Voice & Multimodal]]
- [[_COMMUNITY_Grey Rock & Narcissism Defense|Grey Rock & Narcissism Defense]]
- [[_COMMUNITY_Pain Relief & Posture|Pain Relief & Posture]]
- [[_COMMUNITY_Strong Mindset & Marriage|Strong Mindset & Marriage]]
- [[_COMMUNITY_Super IC & AI Orchestration|Super IC & AI Orchestration]]
- [[_COMMUNITY_Bad Managers & Mutiny|Bad Managers & Mutiny]]
- [[_COMMUNITY_Longevity & Anti-Aging|Longevity & Anti-Aging]]
...
- [[_COMMUNITY_AI Security Intent Laundering|AI Security Intent Laundering]]
...
- [[_COMMUNITY_AI Impact on Human Survival|AI Impact on Human Survival]]
- [[_COMMUNITY_Modern Software Architecture|Modern Software Architecture]]
- [[_COMMUNITY_Longevity Protocols|Longevity Protocols]]
- [[_COMMUNITY_Workplace Sexual Harassment|Workplace Sexual Harassment]]
- [[_COMMUNITY_AI Social Media Automation|AI Social Media Automation]]
- [[_COMMUNITY_Hip & Physical Recovery|Hip & Physical Recovery]]
- [[_COMMUNITY_iPhone Files & Storage Tips|iPhone Files & Storage Tips]]

## God Nodes (most connected - your core abstractions)
1. `Claude Code 6-Layer Architecture` - 7 edges
2. `Model Context Protocol (MCP)` - 7 edges
3. `帝國主義建設` - 6 edges
4. `IAM四階段成熟度模型` - 6 edges
5. `AI知識系統的革命性轉變：從健忘到複利` - 6 edges
6. `Claude Code代理人團隊與TMUX實戰` - 6 edges
7. `Claude Code洩漏事件深度解析` - 6 edges
8. `Harness Engineering AI前沿` - 6 edges
9. `Harness Engineering獨立開發者` - 6 edges
10. `重新定義智慧：自我進化框架` - 6 edges
...
- `共情力護城河` --semantically_similar_to--> `意義賦予 Sensemaking`  [INFERRED] [semantically similar]
  _notes/ai-era-human-skills-competitive-edge.md → _notes/ai-era-management-decentralization.md
...
### Community 7 - "AI Content Creation"
Cohesion: 0.09
Nodes (24): 內容瀑布分發, 慾望地圖, 知識泉源監控, AI 一人內容創作系統, 幽靈 GDP, 智力溢價回撤, AI 摧毀全球經濟, 優質房貸危機 (+16 more)

### Community 8 - "AGI & AI Safety"
Cohesion: 0.11
Nodes (24): AGI 2年內衝擊所有職業, 通用人工智慧（AGI）, 控制難題（Alignment Problem）, 認知勞動自動化, 教育體系崩潰與重新定義, 硬資產防禦, 個體代理力（Agency）, 程式碼廉價化 (+16 more)

### Community 9 - "Claude Tools & Browser Agents"
Cohesion: 0.09
...
- **Are the 3 inferred relationships involving `IAM四階段成熟度模型` (e.g. with `上下文圖譜治理架構` and `AI代理毀滅性決策風險`) actually correct?**
  _`IAM四階段成熟度模型` has 3 INFERRED edges - model-reasoned connections that need verification._
