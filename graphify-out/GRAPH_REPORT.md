# Graph Report - _notes  (2026-04-30)

## Corpus Check
- 289 files · ~150,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1182 nodes · 1232 edges · 90 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 284 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_AI Agent Team Architecture|AI Agent Team Architecture]]
- [[_COMMUNITY_Salary Negotiation Strategy|Salary Negotiation Strategy]]
- [[_COMMUNITY_AI Context Graph Systems|AI Context Graph Systems]]
- [[_COMMUNITY_AI-Driven Content Creation|AI-Driven Content Creation]]
- [[_COMMUNITY_Agentic Commerce & Orchestration|Agentic Commerce & Orchestration]]
- [[_COMMUNITY_Solo AI-Era Business Strategy|Solo AI-Era Business Strategy]]
- [[_COMMUNITY_AI Design Automation|AI Design Automation]]
- [[_COMMUNITY_Building AI Agent Teams|Building AI Agent Teams]]
...
- [[_COMMUNITY_AI Engineering & PM Velocity|AI Engineering & PM Velocity]]
- [[_COMMUNITY_CRAFT Context Maintenance|CRAFT Context Maintenance]]
- [[_COMMUNITY_AI Safety & AGI Risk|AI Safety & AGI Risk]]
- [[_COMMUNITY_Claude Browser & Scraping Tools|Claude Browser & Scraping Tools]]
- [[_COMMUNITY_LLM Security Vulnerabilities|LLM Security Vulnerabilities]]
- [[_COMMUNITY_Success Mindset & Habits|Success Mindset & Habits]]
- [[_COMMUNITY_Context Graph AI Knowledge|Context Graph AI Knowledge]]
- [[_COMMUNITY_Subscription Economy & Finance|Subscription Economy & Finance]]
- [[_COMMUNITY_Telephony & Voice AI|Telephony & Voice AI]]
- [[_COMMUNITY_Corporate Empire Building|Corporate Empire Building]]
- [[_COMMUNITY_Obsidian PKM Plugins|Obsidian PKM Plugins]]
- [[_COMMUNITY_Weak Manager Navigation|Weak Manager Navigation]]
- [[_COMMUNITY_Dog Emotional Psychology|Dog Emotional Psychology]]
- [[_COMMUNITY_Five Pillars Agentic Engineering|Five Pillars Agentic Engineering]]
- [[_COMMUNITY_Claude Code Memory Systems|Claude Code Memory Systems]]
- [[_COMMUNITY_Economics & Business Foundations|Economics & Business Foundations]]
...
- [[_COMMUNITY_Wealth Through Leverage & Debt|Wealth Through Leverage & Debt]]
- [[_COMMUNITY_Influence Without Authority|Influence Without Authority]]
- [[_COMMUNITY_AI-Era Personal Branding|AI-Era Personal Branding]]
...
- [[_COMMUNITY_AI Agent Failure Modes|AI Agent Failure Modes]]
- [[_COMMUNITY_AI Leadership Transformation|AI Leadership Transformation]]
- [[_COMMUNITY_AI Coding TDD Practices|AI Coding TDD Practices]]
- [[_COMMUNITY_Anti-Cancer & Wellness|Anti-Cancer & Wellness]]
- [[_COMMUNITY_AI Startup Revenue Strategy|AI Startup Revenue Strategy]]
- [[_COMMUNITY_Workplace Politics & Narrative|Workplace Politics & Narrative]]
- [[_COMMUNITY_AI Engineer Role Evolution|AI Engineer Role Evolution]]
- [[_COMMUNITY_Context Window Theory|Context Window Theory]]
- [[_COMMUNITY_AI Creative Direction|AI Creative Direction]]
- [[_COMMUNITY_AI Evaluation & LLM Judging|AI Evaluation & LLM Judging]]
- [[_COMMUNITY_NVIDIA & Physical AI|NVIDIA & Physical AI]]
- [[_COMMUNITY_Political Operators Defense|Political Operators Defense]]
...
3. `Decision Record (DR)` - 8 edges
4. `1-3-3 安裝法則` - 8 edges
5. `反框架工程哲學：Matt Pocock 技能庫的輕量化 AI 開發之道` - 8 edges
6. `Claude Code 6-Layer Architecture` - 7 edges
7. `Model Context Protocol (MCP)` - 7 edges
8. `六大記憶層級系統` - 7 edges
9. `Software 3.0：從氛圍編程到智能體工程的範式轉移` - 7 edges
10. `餵給 Claude 正確脈絡：CRAFT 脈絡維護的工程實踐` - 7 edges
...
- `模型上下文協定（MCP）` --semantically_similar_to--> `代理人腳手架（Agent Scaffolding）`  [INFERRED] [semantically similar]
  _notes/google-cloud-next-26-developer-keynote.md → _notes/how-to-become-builder-pm.md
...
- **AI 上下文槓桿模式：情境預熱 + 結構化事實 + 上下文複利** — craft_context_warming, craft_structured_project_facts, karpathy_contextual_compounding, matt_contextual_compounding [INFERRED 0.85]
...
### Community 0 - "AI Agent Team Architecture"
Cohesion: 0.04
...
### Community 7 - "Building AI Agent Teams"
Cohesion: 0.07
...
### Community 8 - "AI-Era Product Management"
Cohesion: 0.07
...
### Community 10 - "AI Engineering & PM Velocity"
Cohesion: 0.08
Nodes (25): 代碼品味（Code Taste）守門員, 深層模組架構（Deep Modules）, 100% 自動化法則, 常青發佈室（Evergreen Launch Room）, 極速迭代文化, PM 角色轉型（資源協調→品味決策）, 產品品味（Product Taste）, 無頭自主模式（Headless/Autonomous） (+17 more)

### Community 11 - "CRAFT Context Maintenance"
Cohesion: 0.13
Nodes (25): 餵給 Claude 正確脈絡：CRAFT 脈絡維護的工程實踐, 冷啟動提示 (Cold-start Prompting), 脈絡漂移 (Context Drift), CRAFT 脈絡圖 (Context Graph), 脈絡溫機 (Context Warming), 修正迴圈 (Correction Loop), CRAFT 法則 (Create-Refine-Anchor-Filter-Track), 結構化專案事實 (Structured Project Facts) (+17 more)

### Community 12 - "AI Safety & AGI Risk"
Cohesion: 0.11
Nodes (24): AGI 2年內衝擊所有職業, 通用人工智慧（AGI）, 控制難題（Alignment Problem）, 認知勞動自動化, 教育體系崩潰與重新定義, 硬資產防禦, 個體代理力（Agency）, 程式碼廉價化 (+16 more)

### Community 13 - "Claude Browser & Scraping Tools"
Cohesion: 0.09
...
### Community 17 - "Subscription Economy & Finance"
Cohesion: 0.1
Nodes (21): 黑暗模式, 所有權, 訂閱制陷阱, 房產贈與稅務陷阱, 資產傳承策略, 公告現值, 產業聚落效應, 矽盾 (+13 more)

### Community 18 - "Telephony & Voice AI"
Cohesion: 0.11
...
### Community 26 - "AI Presentation Automation"
Cohesion: 0.13
...
### Community 35 - "AI Coding TDD Practices"
Cohesion: 0.19
...
### Community 44 - "Political Operators Defense"
Cohesion: 0.2
...
## Knowledge Gaps
- **502 isolated node(s):** `PRD產品思維框架`, `資訊不對稱消除`, `LLM Wiki`, `極簡框架原則`, `Markdown外部記憶` (+497 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 85`** (2 nodes): `激勵機制對齊 (Incentive Alignment)`, `稀缺性與資源分配 (Scarcity & Resource Allocation)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `操作員模式（Operator Mode）`, `Worktree 工作樹隔離`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `中心輻射架構（Hub-and-Spoke）`, `分割與合併模式（Split and Merge）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `生產力悖論（AI 使用感知與實際產出落差）`, `Token Maxing（指標武器化現象）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `代理人團隊模式（Agent Teams）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Should `Salary Negotiation Strategy` be split into smaller, more focused modules?**
  _Cohesion score 0.05 - nodes in this community are weakly interconnected._
- **Should `AI Context Graph Systems` be split into smaller, more focused modules?**
  _Cohesion score 0.06 - nodes in this community are weakly interconnected._
- **Should `AI-Driven Content Creation` be split into smaller, more focused modules?**
  _Cohesion score 0.06 - nodes in this community are weakly interconnected._
- **Should `Agentic Commerce & Orchestration` be split into smaller, more focused modules?**
  _Cohesion score 0.06 - nodes in this community are weakly interconnected._