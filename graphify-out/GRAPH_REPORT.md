...
## Corpus Check
- Large corpus: 936 files · ~22,736,111 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 2089 nodes · 2209 edges · 160 communities detected
- Extraction: 78% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 473 edges (avg confidence: 0.77)
...
2. `Obsidian 必裝插件：新手打造第二大腦的 8 款神器` - 13 edges
3. `視覺筆記封面：MedMe Health 創辦人 Purya Sarmadi 從四次轉型到藥局照護的未來` - 12 edges
4. `情境基礎設施 (Context Infrastructure)` - 11 edges
5. `建立 Agentic OS 讓 AI 穩定產出的底層架構` - 10 edges
6. `Context Engine（上下文引擎）` - 10 edges
7. `MedMe Health` - 10 edges
8. `Microsoft Frontier Company (FDE模式)` - 10 edges
9. `FDE模式 (Forward Deployed Engineering)` - 10 edges
10. `行動法則 S.P.E.E.D. (Sound/Permission/Economy/Environment/Delegation)` - 10 edges
...
- `90%企業投資AI連電費都賺不回來（生產力僅提升5%，IT預算拉爆）` --causes--> `試點疲勞 (Pilot Fatigue)`  [INFERRED]
  images/影片筆記/microsoft-fde-frontier-company.jpg → _notes/microsoft-fde-frontier-company.md
- `視覺筆記封面：MedMe Health 創辦人 Purya Sarmadi 從四次轉型到藥局照護的未來` --features--> `Purya Sarmadi`  [EXTRACTED]
  images/影片筆記/he-picked-the-market-everyone-skipped.jpg → _notes/he-picked-the-market-everyone-skipped.md
...
- **From Fixed Harness to Adaptive Engineering: The Brittleness-Driven Transition** — beyond_harness_fixed_harness, beyond_harness_brittleness_dilemma, beyond_harness_relational_paradigm, beyond_harness_adaptive_engineering [INFERRED 0.70]
- **Emergent Self-Organization Pipeline** — beyond_harness_emergence, beyond_harness_complex_systems_elements, beyond_harness_attractor, beyond_harness_emergent_specialization [INFERRED 0.70]
- **FDE as Dual Lock-in Mechanism (Infrastructure + Cognitive)** — fde_fde, fde_compute_lockin, fde_cognitive_stripping, fde_azure [INFERRED 0.65]
- **G-S-T-I-C SDLC 流程串接（Grilling→to-spec→to-tickets→implement→code-review）** —  [EXTRACTED 1.00]
- **湧現式 Harness 自組織序列（湧現→約束設計→湧現式專業化→吸引子）** —  [EXTRACTED 1.00]
- **自我修復評測迴圈基礎設施（Golden Dataset+AutoAgent+Hypothesis-Branch-Rollback+Harness Engineering）** —  [EXTRACTED 1.00]
...
Cohesion: 0.05
Nodes (43): 適應性工程 (Adaptive Engineering), 吸引子 (Attractor), 吸引子陷阱 (Attractor Trap), 脆弱性困境 (Brittleness Dilemma), 複雜系統核心要素（多樣性/局部互動/遞迴學習/湧現）, 複雜 vs 繁複 (Complex vs. Complicated), 約束設計 (Constraint Design), 持續生產 (Continual Production) (+35 more)
...
Cohesion: 0.06
Nodes (42): 低成本具象化, Code Review 技能（標準軸+規格軸）, 確認閥 (confirmation gate), 紅綠分離（重構移出TDD主迴圈）, 事實與決策分離 (facts vs. decisions), 流程串接 (flow chaining), Grilling 技能, G-S-T-I-C 法則 (+34 more)

### Community 11 - "Community 11"
Cohesion: 0.06
Nodes (40): AI 採用三階段模型（實驗/採用/影響）, 因地制宜的標準化（AI友善程式庫）, Angie Jones, 自動修復迴圈, Builder Bot, 公司世界模型, 六階段成熟度模型, 1% 冠軍計畫 (+32 more)
...
Cohesion: 0.11
Nodes (19): 90%企業投資AI連電費都賺不回來（AI泡沫真相）, 亞馬遜10億美元緊急成立AWS FDE部門阻擊, Azure終身壟斷佈局（客戶資料/工作流綁死Azure）, AI時代的認知剝奪風險（短期效果 vs 長期能力萎縮）, 傳統SaaS vs FDE模式 六維度對比表, 諮詢巨頭最後反擊：多雲策略（AWS+Google Cloud+Azure，總調度師定位）, 傳統諮詢公司生存危機（跳過中間商，內部裁員2.5%）, FDE工程師的「數據清潔工」現實 / GIGO 垃圾進垃圾出 (+11 more)
...
Cohesion: 0.12
Nodes (18): 適應性工程Adaptive Engineering（設計約束條件使Harness自我湧現、穩定並隨環境變化調整；Harness成為持續的輸出而非輸入；工程師設計約束/設定遊戲規則，Agent互動/學習/改變形成湧現式Harness）, 複雜系統核心要素（多樣性：多樣化Agent；局部互動：無全局視角只看鄰近；適應學習：Agent適應→適應循環→不斷循環；湧現：局部適應性循環產生新顆粒或組織；吸引子Attractor：系統不崩解入混沌而沉降於整齊卻僵化的定式）, 總結與展望（隨範型改革AI工程將進入真實世界場景，涉及物理空間與多機構多Agent多人持續接觸；設計工程學科將被迫圍繞「持續生產」重新思考；限制因子不再是模型的強度，而是Harness的適應力）, 約束設計Constraint Design（連續譜：固定工程 vs 適應性工程；案例：Hermes AI自我改善Agent從組織競逐找技術學習垂直智慧；π Pi在設計階段高度可客製化但非runtime中自我重組，設計階段的適應）, 持續生產Continual Production（設計工程學科重新聚焦的核心概念）, 核心金句：Harness不再是你打造的輸入，而是你允許湧現的輸出；限制因子不是模型的強度，而是Harness的適應力, Beyond the Harness：一趟走向適應性工程的旅程（封面圖解）, C-S-R法則（Constrain約束：設計約束條件與過濾規則不預先決定結果；Sense感知：觀察湧現的動態變化；Respond回應：在runtime將調整約束而非停止事件） (+10 more)
...
## Knowledge Gaps
- **876 isolated node(s):** `PRD產品思維框架`, `資訊不對稱消除`, `LLM Wiki`, `極簡框架原則`, `Markdown外部記憶` (+871 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 123`** (2 nodes): `巨嬰 (Giant Infant / Overly Dependent Person)`, `必要的痛苦 (Necessary Suffering)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (2 nodes): `激勵機制對齊 (Incentive Alignment)`, `稀缺性與資源分配 (Scarcity & Resource Allocation)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (2 nodes): `操作員模式（Operator Mode）`, `Worktree 工作樹隔離`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (2 nodes): `中心輻射架構（Hub-and-Spoke）`, `分割與合併模式（Split and Merge）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (2 nodes): `生產力悖論（AI 使用感知與實際產出落差）`, `Token Maxing（指標武器化現象）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (2 nodes): `Naive RAG（基礎檢索增強生成）`, `搜尋滿足效應（Satisfaction of Search）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (2 nodes): `債務優先論（Credit Before Commodity）`, `共識即貨幣（Money as Social Agreement）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (2 nodes): `AI Founder Mode (AI創辦人模式)`, `Consumer AI Renaissance (消費者AI文藝復興)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (2 nodes): `Crawl-Walk-Run-Fly Growth Framework`, `11-Star Experience Framework`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (2 nodes): `資本密集壁壘（Capital Moat）：AI 算力競賽護城河`, `算力替代策略（Compute Substitution）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (2 nodes): `反脆弱成熟（Anti-fragile Adulthood）`, `身份惰性（Identity Inertia）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (2 nodes): `行動優先迴圈（Action-First Loop）`, `逆向定律（Backwards Law）：追逐正面體驗的悖論`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (2 nodes): `Agent 自我診斷機制（Self-Diagnostics）`, `工具框架效應（Tool Framing Effect）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (2 nodes): `Agent 層級 Bitter Lesson（簡單性原則）`, `模型無關性（Model-Agnostic）與記憶系統解耦`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (2 nodes): `激勵相容原則（Incentive Compatibility）`, `價格機制（Price Mechanism）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (2 nodes): `比較優勢（Comparative Advantage）`, `機會成本（Opportunity Cost）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (2 nodes): `行為驅動權限白名單 (Behavior-driven Allow List)`, `權限優先級覆蓋 (Permission Precedence Override)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (2 nodes): `上下文衰退閾值 (Context Rot Threshold)`, `上下文可視化監控 (Context Visibility Monitoring)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `代理人團隊模式（Agent Teams）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `Reference Pack 視覺風格系統`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (1 nodes): `不借錢原則`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `Stainless Steel Grade (304/316/201)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (1 nodes): `Heavy Metal Migration Risk (重金屬遷移)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (1 nodes): `GB 4806.9-2023 Food Contact Metal Standard`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (1 nodes): `Life Arc Three Phases (生命三階段框架)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `Pain + Reflection = Progress (痛苦+反思=進步)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `Transcendental Meditation (超覺靜坐)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `Humility + Audacity Balance (謙遜的槓桿)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `BYOT (Bring Your Own Tokens) SaaS Model`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `透明戰場（Transparent Battlefield）`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `Rajiv Chandegra`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `非同步通知機制 (Asynchronous Notification)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `推播式權限確認 (Push-based Permission Approval)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (1 nodes): `資料隱私最小化 (Data Privacy Minimization)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (1 nodes): `歷史保留窗口 (History Retention Window)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (1 nodes): `Prompt 暫存快取 (Prompt Stash Cache)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (1 nodes): `提交歸因控制 (Commit Attribution Control)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `Oracle-Evaluator-Architect 三層架構` connect `Community 26` to `Community 2`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `Eval 驅動迭代飛輪（Eval-Driven Iteration Loop）` connect `Community 2` to `Community 26`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
