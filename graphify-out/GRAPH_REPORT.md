...
## Summary
- 1204 nodes · 1267 edges · 88 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 296 edges (avg confidence: 0.79)
...
## Knowledge Gaps
- **507 isolated node(s):** `人頭數量化陷阱`, `好人是負債`, `為老闆解決問題`, `僕人領導敘事`, `1% 實驗法則` (+502 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 85`** (2 nodes): `生產力悖論（AI 使用感知與實際產出落差）`, `Token Maxing（指標武器化現象）`
