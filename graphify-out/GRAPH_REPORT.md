# Graph Report - ./_notes  (2026-04-21)
...
## Summary
- 956 nodes · 988 edges · 71 communities detected
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 229 edges (avg confidence: 0.79)
...
- [[_COMMUNITY_Obsidian 工作流建立|Obsidian 工作流建立]]
...
- [[_COMMUNITY_AI 時代個人價值原則|AI 時代個人價值原則]]
- [[_COMMUNITY_Community 26|Community 26]]
- [[_COMMUNITY_企業 AI 轉型策略|企業 AI 轉型策略]]
...
2. `1-3-3 安裝法則` - 8 edges
3. `Claude Code 6-Layer Architecture` - 7 edges
4. `Model Context Protocol (MCP)` - 7 edges
5. `帝國主義建設` - 6 edges
6. `IAM四階段成熟度模型` - 6 edges
7. `AI知識系統的革命性轉變：從健忘到複利` - 6 edges
8. `Claude Code代理人團隊與TMUX實戰` - 6 edges
9. `Claude Code洩漏事件深度解析` - 6 edges
10. `Harness Engineering AI前沿` - 6 edges
...
- `搶奪職責範疇` --semantically_similar_to--> `組織搶奪職責範疇`  [INFERRED] [semantically similar]
  _notes/02-stealing-scope.md → _notes/07-orgs-stealing-scope.md
...
## Knowledge Gaps
- **421 isolated node(s):** `人頭數量化陷阱`, `好人是負債`, `為老闆解決問題`, `僕人領導敘事`, `1% 實驗法則` (+416 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `/insights 行為分析報告` connect `Community 9` to `Community 0`?**
